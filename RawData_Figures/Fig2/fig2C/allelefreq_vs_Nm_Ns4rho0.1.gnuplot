set output  "allelefreq_vs_Nm_Ns4_rho1by10.tex"
...
se label "$s=0.02 \\quad \\mathbf{{\\color{red} Ns=4}} \\quad \\mathbf{{\\color{blue} \\rho=0.1}}$"  at 1.0,1.02
set style function lines


pl "L10_KS4_rho0.1_sims.txt"  u 1:2:((($2*(1-$2)-$3)/2500)**0.5) w yerrorbars ps 1.5 pt 4 lw 3 lc rgb "black" ti "$L=10$",\
"L40_KS4_rho0.1_sims.txt"  u 1:2:((($2*(1-$2)-$3)/10000)**0.5) w yerrorbars ps 1.5 pt 7 lw 3 lc rgb "black" ti "$L=40$",\
"Ks4_L10_Ls0.2_rho0.1.txt" u 1:2 w lines lw 3 lc rgb "black" noti,\
"Ks4_L40_Ls0.8_rho0.1.txt" u 1:2 w lines lw 3 lc rgb "black" noti,\
"KS4_LE_rho0.1.txt" u 1:2 w lines lw 3 lt 3 dt (1,1) lc rgb "black" ti "LE"
