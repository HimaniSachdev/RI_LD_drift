set output  "NmcritVsL_rho3by10.tex"
...
se label "$s=0.02 \\quad \\mathbf{\\rho=0.3}$"  at 0.6,28.7
set style function lines

pl "Nmcrit_vs_L_rho0.3.txt"  u ($1*0.02):2 w lines lw 3 lc rgb "black" ti "$Ns=1$",\
"Nmcrit_vs_L_rho0.3.txt"  u ($1*0.02):3 w lines lw 3 dt (0.25,0.25)lc rgb "red" ti "$Ns=2$",\
"Nmcrit_vs_L_rho0.3.txt"  u ($1*0.02):4 w lines lw 3 dt (1,1) lc rgb "blue" ti "$Ns=4$",\
"Nmcrit_vs_L_rho0.3.txt"  u ($1*0.02):5 w lines lw 3 dt (3,3)  lc rgb "green" ti "$Ns=8$"
